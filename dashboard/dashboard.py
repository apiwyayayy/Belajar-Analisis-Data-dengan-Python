...
# read dataset
all_df = pd.read_csv('https://raw.githubusercontent.com/apiwyayayy/Belajar-Analisis-Data-dengan-Python/refs/heads/main/dashboard/main_data.csv')
geo_df = pd.read_csv('https://raw.githubusercontent.com/apiwyayayy/Belajar-Analisis-Data-dengan-Python/refs/heads/main/dashboard/geolocation.csv')
...
with st.sidebar:
    ...
    st.caption('Copyright (C) Ravy 2024')
